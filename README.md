...
services:
  dynamocker-be:
    image: raffarus/dynamocker-be:0.0.7
    ports:
      - ${BE_PORT}:8150
    volumes:
    ...
    environment:
      - BE_PORT=${BE_PORT}
  dynamocker-fe:
    image: raffarus/dynamocker-fe:0.0.7
    ports:
      - ${FE_PORT}:8151
    environment:
      - FE_PORT=${FE_PORT}
...
```
$ wget https://github.com/RaffaRus/dynamocker/releases/download/dynamocker-0.0.7/dynamocker-0.0.7.tgz
```
